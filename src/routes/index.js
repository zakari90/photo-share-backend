...
import { createNewPost, deleteMyPost, getAllMyPosts, getAllPosts, updateMyPost, updatePostImage } from "../controllers/post-controller.js";
...
router.put("/posts/:postId/update-post-image", upload.single("image"), isLoggedIn, updatePostImage);
